export default function UserMetrics() {
  return (
    <div className="max-w-md mx-auto p-6 bg-white dark:bg-zinc-900 rounded-2xl shadow-md border border-zinc-200 dark:border-zinc-800 transition-colors duration-300">
      ...
      <div className="space-y-5">
        ...
        <button className="w-full mt-4 h-12 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-xl transition-all shadow-lg shadow-blue-500/20 active:scale-[0.98]">
          Сохранить данные
        </button>
      </div>
    </div>
